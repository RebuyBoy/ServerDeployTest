...
//
//import com.rakecounter.models.Actions;
...
//            Actions heroActions = getHeroInvestments(hand);
...
//
//
//    private void countProfit(Actions heroActions) {
//        double profit = 0;
...
////
////    }
//    private Actions getHeroInvestments(String hand) {
...
//        Actions heroActions = new Actions();
//        double antes = 0;
...
//    }
//
//    private double getProfit(Actions heroActions) {
...
//    }
//
//    private Actions setInvestments(Actions heroActions) {
...
//    }
//
//    private double getInvestments(List<String> actions, Actions heroActions) {
//        double investment = 0;
